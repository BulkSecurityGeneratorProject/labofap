...
import fr.labofap.api.repository.AuthorityRepository;
...
import fr.labofap.api.service.util.RandomUtil;
import fr.labofap.api.service.dto.UserDTO;
import fr.labofap.api.web.rest.vm.ManagedUserVM;
...
public class UserService {
    ...
    public Authority registerAuthority(String authorityName){
    ...
    public User registerUser(ManagedUserVM userDTO) {
        ...
        //String acivationKey = RandomUtil.generateActivationKey();
        //newUser.setActivationKey(acivationKey);
        newUser.setActivationKey(null);
        newUser.setActivated(true);
        //authorities.add(authority);
        newUser.setAuthorities(authorities);
        userRepository.save(newUser);
        //activateRegistration(acivationKey);
