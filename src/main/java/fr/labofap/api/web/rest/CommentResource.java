...
public class CommentResource {
    ...
    public CommentResource(CommentService commentService, MediaService mediaService) {
     ...
     *
     * @param commentInputDTO the commentInputDTO to create
    ...
    @Timed
    public ResponseEntity<CommentDTO> createComment(@RequestBody CommentInputDTO commentInputDTO) throws URISyntaxException {
        log.debug("REST request to save Comment : {}", commentInputDTO);

        CommentDTO result = commentService.save(commentInputDTO);
    ...
    public ResponseEntity<CommentDTO> updateComment(@RequestBody CommentDTO commentDTO) throws URISyntaxException {
        ...
        if (commentDTO.getId() == null) {
            ...
            inputDTO.setOrderId(commentDTO.getOrderId());
            inputDTO.setContent(commentDTO.getContent());
            return createComment(inputDTO);
        }
    ...
    @GetMapping("/comments/{id}/medias")
    @Timed
    public ResponseEntity<List<MediaDTO>> getMediasByCommentId(@PathVariable Long id) {
        log.debug("REST request to get Comment : {}", id);
        CommentDTO commentDTO = commentService.findOne(id);

        List<MediaDTO> commentDTOS = mediaService.findAll(commentDTO);
